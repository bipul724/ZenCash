...
export const AnimatedTestimonials = ({
  ...
  // Generate stable rotation values that won't change between server and client
  const rotationValues = useMemo(() => {
    return testimonials.map((_, index) => {
      // Use index as seed for consistent "random" values
      const seed = index * 17 + 42; // Simple seed generation
      return ((seed % 21) - 10); // Generate values between -10 and 10
    });
  }, [testimonials]);
